...
export const pending_file = "/var/lib/idwt/pending.yml"

export const tighten_temp_file = "/var/spool/idwt/idwt-tighten"

export const idwt_bin = "/usr/bin/idwt"
export const tighten_apply_bin = "/usr/libexec/idwt/tighten-apply.nu"
