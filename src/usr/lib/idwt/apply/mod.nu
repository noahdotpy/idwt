...
export def "apply process-killing" [] {
...
export def "apply delayed-rules" [] {
...
export def "apply block-kwin-windows" [] {
...
export def "apply flatpak-app-networking" [] {
...
export def "apply block-networking" [] {
